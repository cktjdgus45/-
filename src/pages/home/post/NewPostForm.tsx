...
const NewPostForm = ({ setAddPostForm }: INewPostFormProps) => {
    ...
    return (
        <Overlay onClose={handleClose}>
            <form onSubmit={handleSubmitForm} encType='multipart/form-data' onClick={preventCloseEventFromOverlay} className="relative w-1/3 flex-col items-end bg-white p-2 mobile:p-8 rounded-lg shadow-md">
                <TextInputField
                    autoFocus
